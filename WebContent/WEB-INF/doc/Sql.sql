SELECT EMPLOYEE.MEMBER_NO FROM EMPLOYEE
MINUS
SELECT EMPLOYEE.MEMBER_NO FROM EMPLOYEE, PROJECT_JOIN WHERE EMPLOYEE.MEMBER_NO=PROJECT_JOIN.MEMBER_NO
AND PROJECT_JOIN.PROJECT_NO=21;

SELECT
					CAREER.CAREER_NO AS CAREER_NO, 
