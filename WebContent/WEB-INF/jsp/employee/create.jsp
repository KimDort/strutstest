				...
				<div class="col-md-12" id="career-group">
					...
					<div class="row" id="period_box">
						<c:if test="${not empty career }">
							...
							<div class='col-md-12 form-inline' id='period_line'><div class='form-group'><label>Period</label>
							...
							<input type='text' class='form-control' name='career.period_company' id='period_company' value="${idx.period_company }"></div>
							<div class='form-group'><label>Rank</label>
							<select class='form-control' name='career.period_rank' id='period_rank' style='width: 100px'>
								<option value=''></option>
								<option value='Chairman'>Chairman</option>
								<option value='Vice Chairman'>Vice Chairman</option>
								<option value='CEO'>CEO</option>
							...
							<input type='text' class='form-control' name='career.period_position' id='period_position' value="${idx.period_position }">
				...
				<div class="col-md-12" id="license-group">
					...
					<div class="row" id="license_box">
						<c:if test="${not empty license }">
							...
							<div class='form-group'><label>Get Date</label>
							<input type='text' class='form-control' name='license.license_date' readonly='readonly' value="${idx.license_date }"></div>
