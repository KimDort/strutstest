			...
			<form action="${pageContext.request.contextPath }/project/register.do" method="post" id="frm">
				...
				<table class="table table-hover" style="width: 100%;">
					...
					<tr>
							...
							<td>
								<input type="text" placeholder="Please Write Name" class="form-control" name="name">
							</td>
						</tr>
						<tr>
							<th>Content</th>
							<td>
								<input type="text" placeholder="Please Write Content" class="form-control" name="content">
							</td>
						</tr>
						<tr>
							<th>Start Day</th>
						...
						<tr>
							<th>ETC</th>
							<td>
								<input type="text" placeholder="Please Write Date" class="form-control" name="etc">
							</td>
						</tr>
					</tbody>
					<tfoot>
